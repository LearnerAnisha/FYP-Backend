...
class CropSuggestionSerializer(serializers.ModelSerializer):
    conversation_session_id = serializers.CharField(
        source="conversation.session_id", read_only=True
    )
...
class WeatherDataSerializer(serializers.ModelSerializer):
    class Meta:
        model = WeatherData
        fields = ["id", "location", "current_weather", "forecast_data", "fetched_at"]
...
class AdminActivityLogSerializer(serializers.ModelSerializer):
    ...
    admin_user_email = serializers.CharField(
        source="admin_user.email", read_only=True, allow_null=True
    )
    target_user_name = serializers.CharField(
        source="target_user.full_name", read_only=True, allow_null=True
    )
