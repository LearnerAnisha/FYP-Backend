...
class PaymentInitSerializer(serializers.Serializer):
    ...
    service_charge  = serializers.DecimalField(max_digits=12, decimal_places=2, default=Decimal("0.00"), required=False)
    delivery_charge = serializers.DecimalField(max_digits=12, decimal_places=2, default=Decimal("0.00"), required=False)
