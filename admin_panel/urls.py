...
urlpatterns = [
    ...
    path(
        "products/<int:id>/",
        AdminMasterProductDetailView.as_view(),
        name="admin-product-detail",
    ),
    path(
        "history/", AdminDailyPriceHistoryListView.as_view(), name="admin-price-history"
    ),
    path(
        "history/<int:id>/",
        AdminDailyPriceHistoryDetailView.as_view(),
        name="admin-price-history-detail",
    ),
    path(
        "analysis/", AdminMarketPriceAnalysisView.as_view(), name="admin-price-analysis"
    ),
